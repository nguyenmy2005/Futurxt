    ...
    const draw = () => {
      ...
      for (const s of stars) {
        ...
        if (theme === "dark") {
          ...
          ctx.fillStyle = `rgba(235,242,255,${tw.toFixed(3)})`;
          ctx.fill();
        } else {
          const g = ctx.createRadialGradient(s.x, s.y, 0, s.x, s.y, s.r * 4);
          g.addColorStop(0, `rgba(70,85,140,${(tw * 0.35).toFixed(3)})`);
          ...
          ctx.beginPath();
          ctx.arc(s.x, s.y, s.r, 0, Math.PI * 2);
          ctx.fillStyle = `rgba(50,65,110,${tw.toFixed(3)})`;
          ctx.fill();
        }
...
export function IdeaSection({ theme, onToggleTheme }: IdeaSectionProps) {
  ...
  // Màu text sắc nét theo theme
  const textPrimary = isDark ? "#ffffff" : "#0a0a0a";
  const textSecondary = isDark ? "rgba(255,255,255,0.82)" : "rgba(10,10,10,0.75)";
  const textMuted = isDark ? "rgba(255,255,255,0.35)" : "rgba(0,0,0,0.38)";
  const bgColor = isDark ? "#000000" : "#f8f8f6";
  ...
  return (
    <section
      ...
      style={{
        position: "relative",
        width: "100%",
        // ✅ dùng 100dvh — fill kín màn hình thực tế, kể cả khi có browser bar
        height: "100dvh",
        minHeight: "100dvh",
        background: bgColor,
    ...
    >
      ...
      {/* ✅ StarField fill 100% section — không còn khoảng trống */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          zIndex: 2,
          // canvas bên trong tự fill 100% width/height của div này
        }}
      >
      ...
      <div
        style={{
          ...
          background: isDark
            ...
            : "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(100,120,200,0.04) 0%, transparent 70%)",
          transition: "background 0.45s ease",
        }}
      />
      ...
      <div
        style={{
          ...
          // Đảm bảo không bị clip trên mobile khi có safe area
          ...
          {(["FROM IDEA", "TO SCALE"] as const).map((line, i) => (
            <h2
              ...
              style={{
                fontFamily: serif,
                fontSize: isMobile
                  ? "clamp(3rem,17vw,5.2rem)"
                  : "clamp(3.5rem,8.5vw,8rem)",
                fontWeight: 900,
                color: textPrimary,
                ...
                // ✅ text-shadow nhẹ — sắc nét, không nhòe
                textShadow: isDark
          ...
          <motion.div
            ...
            style={{
              ...
              background: isDark
                ...
                : "linear-gradient(to right, transparent, rgba(0,0,0,0.28), transparent)",
        ...
        <motion.button
          ...
          style={{
            ...
            boxShadow: isDark
              ...
              : "0 1px 0 rgba(255,255,255,0.12) inset, 0 6px 24px rgba(0,0,0,0.22)",
        ...
        >
          <span
            style={{
              fontFamily: serif,
              fontSize: isMobile
                ? "clamp(0.92rem,3.8vw,1.1rem)"
                : "clamp(1rem,1.75vw,1.28rem)",
              fontWeight: 600,
              color: isDark ? "rgba(255,255,255,0.97)" : "#ffffff",
